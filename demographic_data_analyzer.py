...
def calculate_demographic_data(print_data=True):
   ...
   race_count = df['race'].value_counts()
    ...
    earning_ratio_by_country = (df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts())
    max_earning_ratio = earning_ratio_by_country.max()

    highest_earning_country = earning_ratio_by_country[earning_ratio_by_country == max_earning_ratio].index[0]
